...
var data = JSON.stringify({   //Convertir string a json
    ...
    "document":{ // es el parametro del que quiero traer la informacion
        "cedula": 987456321,
        "nombre": "mateito",
        "edad": 26
    },
...
var config = {
    method: 'post',
    url: 'https://data.mongodb-api.com/app/data-gowxd/endpoint/data/v1/action/insertOne', //url de la api
    headers: {
